...
const commonClass =
  "input input-lg border-0 border-b-2 focus:outline-none focus:placeholder:text-baay_pm-primary placeholder:text-[15px] md:placeholder:text-lg focus:border-baay_pm-primary border-[#E6E8EB] w-full rounded-none px-0";
...
const Form = () => {
  return (
    <div>
      ...
      <div className="mx-2">
        <form
          action="https://formspree.io/f/xnjkokap"
          method="POST"
